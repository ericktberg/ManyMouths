...
CREATE TABLE `store_chain` (
  `store_chain_id` int unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `store_location` (
  ...
  `store_chain_id` int unsigned NOT NULL COMMENT 'A reference to a certain chain that this location is franchising',
...
-- Dump completed on 2023-09-14 20:56:19
